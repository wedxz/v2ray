_download_caddy_file() {
	...
	if [[ $sys_bit == "i386" || $sys_bit == "i686" ]]; then
		local caddy_download_link="https://caddyserver.com/api/download?os=linux&arch=386&license=personal"
	else
		local caddy_download_link="https://caddyserver.com/api/download?os=linux&arch=amd64&license=personal"
	fi
